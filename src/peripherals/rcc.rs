use crate::{peripherals::regs::*, tremo_analog_rd, tremo_analog_wr, tremo_reg_en, tremo_reg_set};
    ...
    pub fn enable_peripheral_clk(&mut self, peripheral: u32, new_state: bool) {
        match peripheral {
            RCC_PERIPHERAL_UART0 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_UART0_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_UART1 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_UART1_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_UART2 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_UART2_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_UART3 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_UART3_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_LPUART => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_LPUART_CLK_EN_MASK, new_state);
                while (self.clone().sr & RCC_SR_ALL_DONE) != RCC_SR_ALL_DONE {}
                tremo_reg_en!(self, cgr2, RCC_CGR2_LPUART_AON_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_SSP0 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_SSP0_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_SSP1 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_SSP1_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_SSP2 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_SSP2_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_QSPI => {
                tremo_reg_en!(self, cgr1, RCC_CGR1_QSPI_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_I2C0 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_I2C0_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_I2C1 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_I2C1_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_I2C2 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_I2C2_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_ADC => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_ADC_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_DAC => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_DAC_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_AFEC => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_AFEC_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_LCD => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_LCD_CLK_EN_MASK, new_state);
                while (self.clone().sr & RCC_SR_ALL_DONE) != RCC_SR_ALL_DONE {}
                tremo_reg_en!(self, cgr2, RCC_CGR2_LCD_AON_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_LORA => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_LORA_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_GPIOA => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_IOM0_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_GPIOB => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_IOM1_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_GPIOC => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_IOM2_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_GPIOD => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_IOM3_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_TIMER0 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_TIMER0_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_TIMER1 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_TIMER1_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_TIMER2 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_TIMER2_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_TIMER3 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_TIMER3_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_BSTIMER0 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_BSTIMER0_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_BSTIMER1 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_BSTIMER1_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_LPTIMER0 => {
                if new_state {
                    tremo_reg_en!(self, cgr1, RCC_CGR1_LPTIMER0_PCLK_EN_MASK, new_state);
                    while (self.clone().sr & RCC_SR_ALL_DONE) != RCC_SR_ALL_DONE {}
                    tremo_reg_en!(self, cgr2, RCC_CGR2_LPTIMER0_AON_CLK_EN_MASK, new_state);
                    tremo_reg_en!(self, cgr1, RCC_CGR1_LPTIMER0_CLK_EN_MASK, new_state);
                } else {
                    tremo_reg_en!(self, cgr1, RCC_CGR1_LPTIMER0_CLK_EN_MASK, new_state);
                    while (self.clone().sr & RCC_SR_ALL_DONE) != RCC_SR_ALL_DONE {}
                    tremo_reg_en!(self, cgr2, RCC_CGR2_LPTIMER0_AON_CLK_EN_MASK, new_state);
            ...
            RCC_PERIPHERAL_LPTIMER1 => {
                if new_state {
                    tremo_reg_en!(self, cgr1, RCC_CGR1_LPTIMER1_PCLK_EN_MASK, new_state);
                    while (self.clone().sr & RCC_SR_ALL_DONE) != RCC_SR_ALL_DONE {}
                    tremo_reg_en!(self, cgr2, RCC_CGR2_LPTIMER1_AON_CLK_EN_MASK, new_state);
                    tremo_reg_en!(self, cgr1, RCC_CGR1_LPTIMER1_CLK_EN_MASK, new_state);
                } else {
                    tremo_reg_en!(self, cgr1, RCC_CGR1_LPTIMER1_CLK_EN_MASK, new_state);
                    while (self.clone().sr & RCC_SR_ALL_DONE) != RCC_SR_ALL_DONE {}
                    tremo_reg_en!(self, cgr2, RCC_CGR2_LPTIMER1_AON_CLK_EN_MASK, new_state);
            ...
            RCC_PERIPHERAL_IWDG => {
                tremo_reg_en!(self, cgr1, RCC_CGR1_IWDG_CLK_EN_MASK, new_state);
                while (self.clone().sr & RCC_SR_ALL_DONE) != RCC_SR_ALL_DONE {}
                tremo_reg_en!(self, cgr2, RCC_CGR2_IWDG_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_WDG => {
                tremo_reg_en!(self, cgr1, RCC_CGR1_WDG_CLK_EN_MASK, new_state);
                tremo_reg_en!(self, cgr1, RCC_CGR1_WDG_CNT_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_RTC => {
                tremo_reg_en!(self, cgr1, RCC_CGR1_RTC_CLK_EN_MASK, new_state);
                while (self.clone().sr & RCC_SR_ALL_DONE) != RCC_SR_ALL_DONE {}
                tremo_reg_en!(self, cgr2, RCC_CGR2_RTC_AON_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_CRC => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_CRC_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_SEC => {
                tremo_reg_en!(self, cgr1, RCC_CGR1_SEC_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_SAC => {
                tremo_reg_en!(self, cgr1, RCC_CGR1_SAC_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_I2S => {
                tremo_reg_en!(self, cgr1, RCC_CGR1_I2S_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_DMA0 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_DMAC0_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_DMA1 => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_DMAC1_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_RNGC => {
                tremo_reg_en!(self, cgr1, RCC_CGR1_RNGC_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_SYSCFG => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_SYSCFG_CLK_EN_MASK, new_state);
            }
            RCC_PERIPHERAL_PWR => {
                tremo_reg_en!(self, cgr0, RCC_CGR0_PWR_CLK_EN_MASK, new_state);
            }
            _ => {}
        }
    }
