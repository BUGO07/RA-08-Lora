...
impl GpioPin {
    pub const RED_LED: Self = Self::Pin5;
    pub const GREEN_LED: Self = Self::Pin4;
    pub const BLUE_LED: Self = Self::Pin7;
    pub const COOL_WHITE_LED: Self = Self::Pin14;
    pub const WARM_WHITE_LED: Self = Self::Pin15;
}
...
impl Gpio {
    ...
    pub fn config_stop3_wakeup(&self, gpio_pin: GpioPin, enable: bool, wake_up: bool) {
        ...
        set_reg_bits!(self.stop3_wucr, tmp_mask << (4 * group), tmp << (4 * group));
    }
